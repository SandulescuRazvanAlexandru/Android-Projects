...
public class AdaugarePersoaneActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            persoana = (Persoana) intent.getSerializableExtra(NEW_PERSOANA_KEY);
            buildViewsFromPersoana(persoana);
        }
        else
        {
    ...
    private View.OnClickListener salvarePersoaneEventListener() {
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (validate()) {
                    Persoana persoana = createPersoanaFromView();
    ...
    private Persoana createPersoanaFromView() {
        ...
        return new Persoana(numePersoana,varstaPersoana,genPersoana,greutatePersoana,inaltimePersoana,dataPersoana);
    }

    private void buildViewsFromPersoana(Persoana persoana)
    {
        if(persoana == null)
        {
            return;
