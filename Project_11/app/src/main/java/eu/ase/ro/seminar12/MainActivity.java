...
import eu.ase.ro.seminar12.firebase.Callback;
import eu.ase.ro.seminar12.firebase.FirebaseService;
import eu.ase.ro.seminar12.util.Coach;
import eu.ase.ro.seminar12.util.CoachAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initComponents() {
        ...
        fabChart.setOnClickListener(drawChart());
    }
    ...
    private View.OnClickListener drawChart() {
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(ChartActivity.COACHES, (Serializable) coaches);
